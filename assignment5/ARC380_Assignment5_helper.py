...
def capture_img(visualize: bool = False, save: bool = False, path: str = 'img.png') -> np.ndarray:
    ...
    Args:
        visualize (bool, optional): Displays the image if True. Defaults to False.
        save (bool, optional): Saves the image to 'path' if True. Defaults to False.
        path (str, optional): Path used to save image. Defaults to 'img.png'.
